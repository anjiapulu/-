...
main()
{
	...
	while (1)
	{
		...
		if (1)
		{
			...
			while (ECHOR);  //等待低电平
			TR0 = 0;
			S1 = TH0 * 256 + TL0;//取出定时器值高8位和低8位合并
			...
			while (ECHOR);  //等待低电平
			TR0 = 0;
			S2 = TH0 * 256 + TL0;//取出定时器值高8位和低8位合并
			...
			while (ECHOR);  //等待低电平
			TR0 = 0;
			S3 = TH0 * 256 + TL0;//取出定时器值高8位和低8位合并
			...
			while (ECHOR);  //等待低电平
			TR0 = 0;
			S4 = TH0 * 256 + TL0;//取出定时器值高8位和低8位合并
			...
			while (ECHOR);  //等待低电平
			TR0 = 0;
			S5 = TH0 * 256 + TL0;//取出定时器值高8位和低8位合并
